...
<template>
  <PostFull :display-post="displayPost" @start-comment="isPopUpBoxVisible = true; popUpBox?.setVisible(true)"/>
  <PopUpBox v-if="isPopUpBoxVisible" ref="popUpBox" :save-handler-callback="savePostCallback" box-type="comment"/>
</template>
